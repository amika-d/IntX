  ...
  return (
    <div className='flex p-6 mx-8 my-4 items-center justify-between  bg-opacity-90 rounded-4xl bg-secondary shadow-sm'>
      ...
      <ul className='hidden md:flex gap-6 text-black'>
        ...
        <li className='hover:text-amber-400 cursor-pointer transition-colors duration-300'>Questions</li>
        <li className='hover:text-amber-400 cursor-pointer transition-colors duration-300'>Upgrade</li>
        <li className='hover:text-amber-400 cursor-pointer transition-colors duration-300'>How it works</li>
      </ul>
      <UserButton />
    </div>
  )
